...
# Programming
git --git-dir=modules/vertx-sync/.git --work-tree=modules/vertx-sync add .
git --git-dir=modules/vertx-circuit-breaker/.git --work-tree=modules/vertx-circuit-breaker add .

# Service
git --git-dir=modules/vertx-service-factory/.git --work-tree=modules/vertx-service-factory add .
git --git-dir=modules/vertx-maven-service-factory/.git --work-tree=modules/vertx-maven-service-factory add .
git --git-dir=modules/vertx-http-service-factory/.git --work-tree=modules/vertx-http-service-factory add .
...
# Security
git --git-dir=modules/vertx-auth/.git --work-tree=modules/vertx-auth add .
